...
>>>>>>> 816fa483d4346f2651c58f2ba269268c7cfca0df
...
meandiffReading <- filter(STAR, kinder == 'small') %>% pull(g4reading) %>% mean(na.rm = T) - filter(STAR, kinder == 'regular') %>% pull(g4reading) %>% mean(na.rm = T)
meandiffMath <- filter(STAR, kinder == 'small') %>% pull(g4math) %>% mean(na.rm = T) - filter(STAR, kinder == 'regular') %>% pull(g4math) %>% mean(na.rm = T)
...
readingpctSmall <- filter(STAR, kinder == 'small') %>% pull(g4reading) %>% quantile(na.rm = T, probs = c(0.33, 0.66))
readingpctRegular <- filter(STAR, kinder == 'regular') %>% pull(g4reading) %>% quantile(na.rm = T, probs = c(0.33, 0.66))
mathpctSmall <- filter(STAR, kinder == 'small') %>% pull(g4math) %>% quantile(na.rm = T, probs = c(0.33, 0.66))
mathpctRegular <- filter(STAR, kinder == 'regular') %>% pull(g4math) %>% quantile(na.rm = T, probs = c(0.33, 0.66))
...
readingdiffSmall <- filter(white, kinder == 'small') %>% pull(g4reading) %>% mean(na.rm = T) - filter(minority, kinder == 'small') %>% pull(g4reading) %>% mean(na.rm = T)
readingdiffRegular <- filter(white, kinder == 'regular') %>% pull(g4reading) %>% mean(na.rm = T) - filter(minority, kinder == 'regular') %>% pull(g4reading) %>% mean(na.rm = T)
mathdiffSmall <- filter(white, kinder == 'small') %>% pull(g4math) %>% mean(na.rm = T) - filter(minority, kinder == 'small') %>% pull(g4math) %>% mean(na.rm = T)
mathdiffRegular <- filter(white, kinder == 'regular') %>% pull(g4math) %>% mean(na.rm = T) - filter(minority, kinder == 'regular') %>% pull(g4math) %>% mean(na.rm = T)
...
print(tapply(white$hsgrad, white$kinder, mean, na.rm = T) - tapply(minority$hsgrad, minority$kinder, mean, na.rm = T))
cat('\nhigh school graduation rate differences based on years in small classes:\n') 
print(tapply(white$hsgrad, white$yearssmall, mean, na.rm = T) - tapply(minority$hsgrad, minority$yearssmall, mean, na.rm = T))
